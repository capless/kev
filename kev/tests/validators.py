...
class ValidatorsTestCase(unittest.TestCase):
    ...
    def test_required_validator(self):
        ...
        self.assertEquals(str(vm.exception), u'first_name: This value is required')
    ...
    def test_datetime_validator(self):
        ...
        self.assertEquals(str(vm.exception),
            u'date_created: This value should be a valid datetime object.')
        # Test with valid input
    ...
    def test_date_validator(self):
        ...
        self.assertEquals(str(vm.exception),
                          u'date_created: This value should be a valid date object.')
        # Test with valid input
    ...
    def test_integer_validator(self):
        ...
        self.assertEquals(str(vm.exception),
                          u'no_packages: This value should be an integer')
        # Test with valid input
    ...
    def test_max_length_validator(self):
        ...
        self.assertEquals(str(vm.exception),
            u'no_packages: This value should have a length lesser than 2. Currently 123')
        # Test with valid input
    ...
    def test_min_length_validator(self):
        ...
        self.assertEquals(str(vm.exception),
            u'no_packages: This value should have a length greater than 2. Currently 1')
        # Test with valid input
    ...
    def test_max_value_validator(self):
        ...
        self.assertEquals(str(vm.exception),
            u'no_packages: This value should have a value lesser than 2. Currently 3')
        # Test with valid input
